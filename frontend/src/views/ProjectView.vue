...
/* Light-blue refinement pass */
.project-view {
  background:
    radial-gradient(circle at top left, rgba(96, 165, 250, 0.16), transparent 30%),
    linear-gradient(180deg, #eef7ff 0%, #f8fbff 52%, #ffffff 100%) !important;
}
...
.primary-guide .guide-icon-wrapper,
.secondary-guide .guide-icon-wrapper {
