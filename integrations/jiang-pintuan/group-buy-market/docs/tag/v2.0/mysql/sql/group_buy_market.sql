...
# 鐢熸垚鏃堕棿: 2025-02-22 06:32:43 +0000
# ************************************************************
...
VALUES
	(1,100123,'鎵嬪啓MyBatis鎷煎洟娲诲姩','25120208',0,1,2,600,1,'2024-12-07 10:19:40','2026-12-07 10:19:40',NULL,NULL,'2024-12-07 10:19:40','2025-02-16 14:09:17');
...
CREATE TABLE `group_buy_order_list` (
  ...
  `original_price` decimal(8,2) NOT NULL COMMENT '鍘熷浠锋牸',
  `deduction_price` decimal(8,2) NOT NULL COMMENT '鎶樻墸閲戦',
  `pay_price` decimal(8,2) NOT NULL COMMENT '鎶樻墸閲戦',
