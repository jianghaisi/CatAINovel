...
public class AliPayTest {
    ...
    public void test_aliPay_pageExecute() throws AlipayApiException {
        AlipayTradePagePayRequest request = new AlipayTradePagePayRequest();  // 鍙戦€佽姹傜殑 Request绫?
        request.setNotifyUrl(notify_url);
        request.setReturnUrl(return_url);

        JSONObject bizContent = new JSONObject();
        bizContent.put("out_trade_no", "xfg000091001902");  // 鎴戜滑鑷繁鐢熸垚鐨勮鍗曠紪鍙?
        bizContent.put("total_amount", "0.01"); // 璁㈠崟鐨勬€婚噾棰?
        bizContent.put("subject", "娴嬭瘯鍟嗗搧");   // 鏀粯鐨勫悕绉?
        bizContent.put("product_code", "FAST_INSTANT_TRADE_PAY");  // 鍥哄畾閰嶇疆
        request.setBizContent(bizContent.toString());

        String form = alipayClient.pageExecute(request).getBody();
        log.info("娴嬭瘯缁撴灉锛歿}", form);
         ...
         * <input type="hidden" name="biz_content" value="{&quot;out_trade_no&quot;:&quot;100001001&quot;,&quot;total_amount&quot;:&quot;1.00&quot;,&quot;subject&quot;:&quot;娴嬭瘯&quot;,&quot;product_code&quot;:&quot;FAST_INSTANT_TRADE_PAY&quot;}">
    ...
    public void test_alipay_refund() throws AlipayApiException {
        ...
        refundModel.setRefundReason("閫€娆捐鏄?);
        request.setBizModel(refundModel);

        AlipayTradeRefundResponse execute = alipayClient.execute(request);
        log.info("娴嬭瘯缁撴灉锛歿}", execute.isSuccess());
    }
